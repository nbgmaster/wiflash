...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{$root_dir}media/css/reset.css" media="screen" />        
  	<link rel="stylesheet" type="text/css" href="{$root_dir}media/css/form{$tpl_css}.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="{$root_dir}media/css/default{$tpl_css}.css" media="screen" />      
